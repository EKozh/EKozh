...
| **Проект** | **Тип исследования** | **Стек** |**Статус** |
| -------------------- | :--------------------- |:---------------------------:|:---------------------------:|
| [Предсказание выживших на Титанике](https://github.com/EKozh/Titanic) | Задача классификации и оптимизации. Построение модели, которая предсказывает выживших на титанике |Python, Pandas, Sklearn, CatBoost, LightGBM |Завершен|
